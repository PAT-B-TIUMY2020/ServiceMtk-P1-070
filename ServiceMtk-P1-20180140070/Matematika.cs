...
namespace ServiceMtk_P1_20180140070
{
    ...
    public class Matematika : IMatematika
    {
        public int Bagi(int a, int b)
        {
            ...
            catch (Exception ex)
            {
                ...
                //secara default
                //thorow new Exception(ex.Massage) pesan error secara default
                //throw new FaultExcaption("pesan salah"); untuk meloloskan pesan error ynag di kirim ke client
